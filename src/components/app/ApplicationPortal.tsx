      ...
      <section className="w-[60%] p-10 max-md:w-full max-md:p-4 font-medium">
        <article className="">
          ...
          <p className="text-md my-5">
            These are are the guidelines on how to apply for the duales
            studienstipendium scholarship to pursue an eligible bachelor or
            masters degree dual study program at one of our partner
            universities.
          </p>
          <p className="text-md my-5">
            The Duales Studienstipendium scholarship recipients are
            automatically admitted to study their chosen dual study programs at
            one of our partner universities in Germany.
          </p>
          <p className="text-md my-5">
            Applicants would have to fill the online application form and upload
            the following documents on the application portal to successfully
