export default function AddApplicationArtical() {  return (
    <article>
      ...
      Only official German translated copies of application documents by <a
                  ...
                  >
                    ITS
                  </a> should be uploaded except Identity documents such as : international passport, national identity cards or drivers license.
      </p>
      ...
      <p className="my-10 text-center text-2xl font-bold max-md:text-xl">
        All fields with an asterisk <span className="text-yellow-500">*</span> are
        mandatory.
      </p>
    </article>
  );
