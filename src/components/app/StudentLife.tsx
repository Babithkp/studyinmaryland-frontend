    ...
    <main className="flex items-center justify-center ">
      <section className="w-[60%] p-10 max-md:w-full max-md:p-4 font-medium">
        ...
        <article>
          ...
          <p className="text-md my-5">
            The city’s community-oriented atmosphere allows students to build
            meaningful connections both within and outside their universities.
            Many institutions have partnerships with local businesses and
            organizations, providing students with internships, volunteer
            opportunities, and hands-on experiences in their fields of study.
